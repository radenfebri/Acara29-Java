...
CREATE TABLE `tb_transaksi` (
  ...
  `id_barang` int(25) NOT NULL,
  `id_penjual` int(25) DEFAULT NULL,
  `qty` int(25) NOT NULL,
...
INSERT INTO `tb_transaksi` (`no_invoice`, `id_pembeli`, `nama_pembeli`, `alamat`, `id_barang`, `id_penjual`, `qty`, `grand_total`, `is_confirm`) VALUES
(1, 2, 'budi', 'mdoko', 4, NULL, 2, 1797978, 0),
(2, 2, 'budi', 'mdoko', 5, NULL, 5, 50000, 0),
(3, 2, 'budi', 'mdoko', 5, NULL, 1, 10000, 0),
(4, 2, 'budi', 'mdoko', 5, NULL, 2, 20000, 0);
...
--
ALTER TABLE `tb_transaksi`
  MODIFY `no_invoice` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
